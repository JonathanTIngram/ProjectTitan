...
const ParkwideIntervals = () => {
    ...
    const deleteInterval = (id) => {
        Axios.delete(`http://100.24.238.111:3001/deleteParkInterval/${id}`);
        };
    ...
    const editParkInterval = (id) =>{
        Axios.put('http://100.24.238.111:3001/editParkInterval', {
    ...
    return (
        <Container>
            ...
            {useEffect(() => {
                Axios.get('http://100.24.238.111:3001/getParkInterval').then(res => {
