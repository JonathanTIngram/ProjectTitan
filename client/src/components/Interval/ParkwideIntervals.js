...
const ParkwideIntervals = () => {
    ...
    const deleteInterval = (id) => {
        Axios.delete(`http://18.204.6.183:3001/deleteParkInterval/${id}`);
        };
    ...
    const editParkInterval = (id) =>{
        Axios.put('http://18.204.6.183:3001/editParkInterval', {
    ...
    return (
        <Container>
            ...
            {useEffect(() => {
                Axios.get('http://18.204.6.183:3001/getParkInterval').then(res => {
