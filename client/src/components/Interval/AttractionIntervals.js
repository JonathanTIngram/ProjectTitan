...
const AttractionIntervals = (props) => {
    ...
    setShowModal(prev => !prev);
        ...
        const GetIntervals = () => {
            ...
            Axios.get(`http://18.204.6.183:3001/getInterval/:${rideSelect}`).then(res => {
        ...
        const deleteInterval = (ride_name) => {
            Axios.delete(`http://18.204.6.183:3001/deleteInterval/${ride_name}`);
          };
          ...
          const editInterval = (id, rideName) =>{
            Axios.put('http://18.204.6.183:3001/editInterval', {
