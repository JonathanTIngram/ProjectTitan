...
function ChartLine() {
    ...
    const CheckedRideName = () => {
            ...
            Axios.get(`http://34.229.71.224:3001/sendRideNameGraph`).then(res => {
    ...
    const CheckedStat = () => {
        ...
        Axios.get(`http://34.229.71.224:3001/sendStatsGraph`).then(res => {
            //console.log(res.data)
    ...
    const CheckedData = () => {
        ...
        Axios.get(`http://34.229.71.224:3001/getCollectedData`).then(res => {
            //console.log(res.data)
